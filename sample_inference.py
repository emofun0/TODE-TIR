...
rgb = np.array(Image.open('/home/ganyon/data/transcg/scene3/1/rgb1.png'), dtype = np.float32)
# rgb_mask = np.array(Image.open('/home/ganyon/data/transcg/scene3/1/depth1-gt-mask.png'), dtype = np.float32)
depth = np.array(Image.open('/home/ganyon/data/transcg/scene3/1/depth1.png'), dtype = np.float32)
depth_gt = np.array(Image.open('/home/ganyon/data/transcg/scene3/1/depth1-gt.png'), dtype = np.float32)
...
cam_intrinsics = np.load('/home/ganyon/data/transcg/camera_intrinsics/1-camIntrinsics-D435.npy')
