...
import OpenEXR
import numpy as np
from utils.functions import get_surface_normal_from_depth, get_surface_normal_from_depth_transpose
...
def process_data_transpose(
    ...
    depth_original = process_depth(depth.copy(), camera_type=camera_type, depth_min=depth_min, depth_max=depth_max,
    ...
    data_dict['depth_gt_sn'] = get_surface_normal_from_depth_transpose(data_dict['depth_gt'].unsqueeze(0),
                                                             data_dict['fx'].unsqueeze(0), data_dict['fy'].unsqueeze(0),
                                                             data_dict['cx'].unsqueeze(0),
                                                             data_dict['cy'].unsqueeze(0)).squeeze(0)
